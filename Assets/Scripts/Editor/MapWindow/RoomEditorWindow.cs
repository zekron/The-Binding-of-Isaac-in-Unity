...
public class RoomEditorWindow : EditorWindow
{
    ...
    private void OnEnable()
    {
        ...
        emptyTexture = new Texture2D(Room.RoomWidthPixels / 2, Room.RoomHeightPixels / 2);
    }
    ...
    private void DrawSprite(Sprite sprite, Vector2 coordinate)
    {
        ...
        Vector2 pos = center + new Vector2(-(Room.HorizontalUnit - coordinate.x), -(Room.VerticalUnit - coordinate.y)) * UnitPixels - new Vector2(sprite.rect.width / 2, sprite.rect.height / 2);
