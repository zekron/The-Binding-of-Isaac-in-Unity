...
public class TreeModel<T> where T : TreeElement
{
    ...
    {
        return m_Data.FirstOrDefault(element => element.ElementID == id);
    }
    ...
    void Init(IList<T> data)
    {
        ...
        m_MaxID = m_Data.Max(e => e.ElementID);
    }
    ...
    public IList<int> GetAncestors(int id)
    {
        ...
        if (T != null)
        {
            while (T.Parent != null)
            {
                parents.Add(T.Parent.ElementID);
                T = T.Parent;
            }
        }
        return parents;
    ...
    IList<int> GetParentsBelowStackBased(TreeElement searchFromThis)
    {
        ...
        while (stack.Count > 0)
        {
            ...
            {
                parentsBelow.Add(current.ElementID);
    ...
    {
        IList<T> elements = m_Data.Where(element => elementIDs.Contains(element.ElementID)).ToArray();
    ...
    public void AddRoot(T root)
    {
        ...
        root.ElementID = GenerateUniqueID();
        root.Depth = -1;
        m_Data.Add(root);
    }
